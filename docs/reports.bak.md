## Purchase Analytics
- Purpose: Purchases by supplier, item, or category with time breakdown
- filters: company, from_date, to_date, tree_type, doc_type, value_quantity, range
- tree_type options: "Supplier", "Item", "Item Group", "Territory"
...
- example: {"company": "Penang Components Sdn Bhd", "from_date": "2025-01-01", "to_date": "2025-12-31", "tree_type": "Supplier", "doc_type": "Purchase Invoice", "value_quantity": "Amount", "range": "Yearly"}

## Sales Analytics
- Purpose: Sales by customer, item, or category with time breakdown
- filters: company, from_date, to_date, tree_type, doc_type, value_quantity, range
- tree_type options: "Customer", "Item", "Item Group", "Territory", "Sales Person"
- doc_type options: "Sales Order", "Sales Invoice", "Delivery Note"
- value_quantity options: "Amount", "Quantity"
- range options: "Monthly", "Quarterly", "Yearly"
- example: {"company": "Penang Components Sdn Bhd", "from_date": "2025-01-01", "to_date": "2025-12-31", "tree_type": "Customer", "doc_type": "Sales Invoice", "value_quantity": "Amount", "range": "Monthly"}
